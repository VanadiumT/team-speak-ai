<!--
  FlowVarReadNode — 读取流程参数节点 body
-->
<template>
  <div class="flow-var-read-body">
    <template v-if="!editMode || activeTab === 'detail'">
      ...
      <div v-else class="var-waiting">
        <span class="material-symbols-outlined" style="font-size: 14px; color: #64748b;">input</span>
        <span>等待读取...</span>
      </div>
    </template>
...
const configFields = [
  { key: 'key', label: '参数 Key', type: 'text', placeholder: 'skill_prompt' },
...
<style scoped>
.flow-var-read-body { padding: 4px 0; }
.var-preview {
