<!--
  SysVarReadNode — 读取系统变量节点 body
-->
<template>
  <div class="sys-var-read-body">
    <template v-if="!editMode || activeTab === 'detail'">
      ...
      <div v-else class="var-waiting">
        <span class="material-symbols-outlined" style="font-size: 14px; color: #64748b;">settings_input</span>
        <span>等待读取...</span>
      </div>
    </template>
...
const configFields = [
  { key: 'key', label: '变量 Key', type: 'text', placeholder: 'global_model' },
  { key: 'default_value', label: '默认值', type: 'text', placeholder: '无' },
]
