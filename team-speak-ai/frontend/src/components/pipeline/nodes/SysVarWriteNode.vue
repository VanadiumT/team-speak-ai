<!--
  SysVarWriteNode — 写入系统变量节点 body
-->
<template>
  <div class="sys-var-write-body">
    <template v-if="!editMode || activeTab === 'detail'">
      ...
      <div v-else class="var-waiting">
        <span class="material-symbols-outlined" style="font-size: 14px; color: #64748b;">settings_output</span>
        <span>等待写入...</span>
      </div>
    </template>
...
const configFields = [
  { key: 'key', label: '变量 Key', type: 'text', placeholder: 'last_response' },
...
<style scoped>
.sys-var-write-body { padding: 4px 0; }
.var-preview {
